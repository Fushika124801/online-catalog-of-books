...
export default class CreateBookPage extends Component{
    constructor(props){
        super(props);
        this.state = {
            name: "",
    ...
    createBook = () => {
        ...
        axios.post("http://localhost:8081/api/v1/books", {
    ...
    render()
    {
        return (
            ...
            <div className="d-flex pt-5  flex-row-reverse pb-5 w-50">
                <button className="btn btn-success btn-lg mr-5" onClick={this.createBook}>Create new book</button>
            </div>
            </div>
        )
    }
