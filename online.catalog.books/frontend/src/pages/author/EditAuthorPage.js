...
export class EditAuthorPage extends Component{
    constructor(props){
        super(props);
        this.state = {
            firstName: "",
    ...
    editAuthor = () => {
        ...
        axios.put(`http://localhost:8081/api/v1/authors/${this.props.author.id}`, {
    ...
    render()
    {
        return (
            ...
            <div className="d-flex pt-5  flex-row-reverse pb-5 w-50">
                <button className="btn btn-success btn-lg mr-5" onClick={this.editAuthor}>Edit author</button>
            </div>
            </div>
        )
    }
